...
def checkReverseRelationship(pName,pGen,sUserId,sGen,rel):
    ...
    if gender_result =='Male' and rel =='Sister':
        ...
        new_rel = 'Father'
    elif gender_result =='Male' and rel =='Wife':
        new_rel = 'Husband'
    elif gender_result =='Female' and rel =='Husband':
        new_rel = 'Wife'
...
# buildRelationship('Biscazzi1981-01-22RichardAndrey','Male','852bc854-640d-4201-a926-dc66fbd83a9d','Wife')
